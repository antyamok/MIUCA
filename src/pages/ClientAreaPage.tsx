...
const ClientAreaPage: React.FC = () => {
  ...
  // If already authenticated, redirect to client dashboard
  React.useEffect(() => {
    if (isAuthenticated) {
      navigate('/client');
    }
  ...
  return (
    <div>
      <PageHeader 
        ...
        backgroundImage="https://images.unsplash.com/photo-1600210491892-03d54c0aaf87?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                ...
                <p className="mt-6">
                  {t('clientArea.noCredentials')} <span className="text-sage">clients@ecodesign.com</span>.
                </p>
              </div>
            </motion.div>
